...
async function cards() {
  ...
  return [
    ...
    { key: 'drive', command: './zen-drive', title: 'Zen Drive', subtitle: 'A relaxing endless drive: procedural roads, four biomes, sunsets and starry nights — right in your browser.', tags: ['three.js', 'procedural', 'webaudio'], image: '/og/drive-shot.jpg' },
